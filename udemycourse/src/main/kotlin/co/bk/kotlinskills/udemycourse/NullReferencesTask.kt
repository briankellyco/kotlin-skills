...
fun main(args: Array<String>) {
    ...
    //val float2: Float = -3847.384 // wrong... requires 'f' as kotlin does not automatically widen
    val float2: Float = -3847.384f

    // 2. Now change both of those variable declarations into nullable variables.
    val float1AsNullable: Float? = -3847.384f
    val float2AsNullable: Float? = -3847.384f
    ...
    val shortArrayAlt: Array<Short> = arrayOf(1,2,3,4,5)
    ...
    //val intArray = intArrayOf() { val assignment = 5; while( assignment <= 200; )} //Yeah ... try that!
    ...
    val primitiveCharArray = charArrayOf('a', 'b', 'c')
    ...
    val z: String? = "I AM IN UPPERCASE"
    z?.let { it -> println(it.toLowerCase().replace("am", "am not")) }
    ...
    myNonNullVariable!!.toDouble() // correct... this would throw a NP
